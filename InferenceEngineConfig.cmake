...
set(InferenceEngine_FOUND TRUE) # Unofficial hack by yours truly and @jameshi16
...
if(TARGET IE::inference_engine)
    ...
    if(NOT IE_ROOT_DIR AND (DEFINED ENV{INTEL_CVSDK_DIR} OR DEFINED ENV{InferenceEngine_DIR} OR InferenceEngine_DIR))
        if(EXISTS "$ENV{INTEL_CVSDK_DIR}/inference_engine")
        ...
        elseif (EXISTS "${InferenceEngine_DIR}")
        ...
        if (WIN32)
           ...
           if (NOT EXISTS "/etc/lsb-release")
            ...
            elseif (${os_name} STREQUAL "Ubuntu 18.04")
                set(_OS_PATH "ubuntu_16.04/") # Unofficial hack by yours truly and @jameshi16
            elseif (${os_name} STREQUAL "CentOS 7")
                set(_OS_PATH "centos_7.4/")
            elseif (${os_name} STREQUAL "poky 2.0")
                set(_OS_PATH "ubuntu_16.04/")
            else()
                message(FATAL_ERROR "${os_name} is not supported. List of supported OS: Ubuntu 14.04, Ubuntu 16.04, CentOS 7, Ubuntu 18.04 (Unofficial)")
            endif()
        endif()
    endif()
